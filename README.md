...
```
okf-agent-memory/
├── docs/                   # Normative convention, roadmap & compatibility analysis
│   ├── CONVENTION.md       # OKF Agent Memory Convention v0.1
│   ├── ROADMAP.md          # Project roadmap & milestones
│   ├── OKF-COMPATIBILITY.md# OKF v0.2 spec compatibility analysis
│   └── ALTERNATIVES.md     # Comparison against Mem0, Letta, ad-hoc markdown
...
│   ├── architecture/       # 5-layer architecture & tooling decisions
│   ├── convention/         # Principles & lifecycle workflows
│   └── roadmap/            # Milestones
├── pkg/okf/                # Zero-dependency Go core library (parser, validator, search, mutate)
├── cmd/okf/                # Standalone CLI and embedded MCP server (stdio)
├── AGENTS.md               # Operating instructions for AI agents
├── Makefile                # Build, test, validate targets
└── README.md
```
